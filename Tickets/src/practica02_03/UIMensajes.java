...
public class UIMensajes extends JPanel {
	 ...
	 */
	public UIMensajes(final Connection conexion, final int id_ticket,
			final Usuario login, final int id_usuario) throws SQLException,
		...
		panel_mensaje_c.setBorder(new TitledBorder(UIManager
				.getBorder("TitledBorder.border"), "Incidencia",
		...
		panel_titulo.setBorder(new TitledBorder(null, "Titulo",
		...
		panel_mensaje.setBorder(new TitledBorder(null, "Mensaje",
				TitledBorder.LEADING, TitledBorder.TOP, null, null));
	...
	public void mostrarTabla(Connection conexion, int id_ticket)
			throws SQLException {
		...
		ArrayList<Mensaje> mensajes = mensajes_bus.mostarMensajes(conexion,
				id_ticket);
	...
	public void enviarMensaje(Connection conexion, int id_ticket, int id_usuario) {
		...
		if (txt_titulo.equals("") && txt_mensaje.equals("")) {
			...
			JOptionPane.showMessageDialog(null,
					"Falta introducir un titulo y el mensaje de la consulta");

		} else if (txt_titulo.equals("")) {

			JOptionPane.showMessageDialog(null,
					"Falta introducir un titulo de la consulta");

		} else if (txt_mensaje.equals("")) {

			JOptionPane.showMessageDialog(null,
					"Falta introducir el mensaje de la consulta");

		} else {

			try {

				Mensaje msg = new Mensaje(txt_titulo.getText(),
						txt_mensaje.getText());
