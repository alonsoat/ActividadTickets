...
public class UIUsuarios extends JPanel {
	...
	private String[] depart = { "Todas", "Administració", "Informàtica",
			"Disseny", "Màrketing" };
	...
	public void mostrarTabla(Connection conexion) throws SQLException {
		...
		if (text_buscar.getText().equals("")) {
			...
			usuarios = usuarios_bus.listarUsuarios(conexion,
			...
			try {
				...
				usuarios = usuarios_bus.listarUsuarios(conexion,
						devolverDepartamento(),
						Integer.parseInt(text_buscar.getText()));
	...
	public void llamarModificarTicket(Connection conexion, Usuario login) {
		...
		String departamento = (String) table.getValueAt(table.getSelectedRow(),
				3);
		boolean admin;
